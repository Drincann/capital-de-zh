# Reader-edition translation task ch04s02-p0016-p0020-r1

## Immutable task metadata

- Chapter: `ch04s02` — 第四章 货币转化为资本
- Paragraphs: `v1-ch04s02-p0016` through `v1-ch04s02-p0020`
- Source slice SHA-256: `61835a8377e1d17ab851e20733e9f3fef77cea417fd29ac946a832a0399025c7`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch04s02/drafts/ch04s02-p0016-p0020-r1.md`
...
```text
[v1-ch04s02-p0016] [MEGA p.149,150]
...
[v1-ch04s02-p0017] [MEGA p.150]
Im eigentlichen Handelskapital erscheint die Form G-W-G′, kaufen um theurer zu verkaufen, am reinsten. Andrerseits geht seine ganze Bewegung innerhalb der Cirkulationssphäre vor. Da es aber unmöglich ist aus der Cirkulation selbst die Verwandlung von Geld in Kapital, die Bildung von Mehrwerth zu erklären, erscheint das Handelskapital unmöglich, sobald Aequivalente ausgetauscht werden 33), daher nur ableitbar aus der doppelseitigen Uebervortheilung der kaufenden und verkaufenden Waarenproducenten durch den sich parasitisch zwischen sie schiebenden Kaufmann. In diesem Sinn sagt Franklin: „Krieg ist Raub, Handel ist Prellerei 34).“ Soll die Verwerthung des Handelskapitals nicht aus bloßer Prellerei der Waarenproducenten erklärt werden, so gehört dazu eine lange Reihe von Mittelgliedern, die hier, wo die Waarencirkulation und ihre einfachen Momente unsre einzige Voraussetzung bilden, noch gänzlich fehlt.

[v1-ch04s02-p0018] [MEGA p.150]
...
[note-024] [MEGA p.151]
36) “Profit, in the usual condition of the market, is not made by exchanging. Had it not existed before, neither could it after that transaction.” (Ramsay l. c. p. 184.)
```
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s02-p0016-p0020-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s02-p0016-p0020-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s02-p0016-p0020-r1 --status meaning_reviewed --review-path chapters/ch04s02/reviews/ch04s02-p0016-p0020-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s02-p0016-p0020-r1 --status readability_reviewed --review-path chapters/ch04s02/reviews/ch04s02-p0016-p0020-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s02-p0016-p0020-r1 --status approved
```
