# Reader-edition translation task ch01-p0006-p0010-r2
...
- Draft output: `chapters/ch01/drafts/ch01-p0006-p0010-r2.md`
...
```powershell
python skill-snapshot/reader-edition-v12/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r2 --status in_progress
python skill-snapshot/reader-edition-v12/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r2 --status drafted
python skill-snapshot/reader-edition-v12/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r2 --status meaning_reviewed --review-path chapters/ch01/reviews/ch01-p0006-p0010-r2-meaning.md
python skill-snapshot/reader-edition-v12/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r2 --status readability_reviewed --review-path chapters/ch01/reviews/ch01-p0006-p0010-r2-readability.md
python skill-snapshot/reader-edition-v12/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r2 --status approved
```
