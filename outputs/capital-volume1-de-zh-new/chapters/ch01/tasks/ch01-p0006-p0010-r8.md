# Reader-edition translation task ch01-p0006-p0010-r8
...
- Draft output: `chapters/ch01/drafts/ch01-p0006-p0010-r8.md`
...
```powershell
python skill-snapshot/reader-edition-v17/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r8 --status in_progress
python skill-snapshot/reader-edition-v17/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r8 --status drafted
python skill-snapshot/reader-edition-v17/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r8 --status meaning_reviewed --review-path chapters/ch01/reviews/ch01-p0006-p0010-r8-meaning.md
python skill-snapshot/reader-edition-v17/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r8 --status readability_reviewed --review-path chapters/ch01/reviews/ch01-p0006-p0010-r8-readability.md
python skill-snapshot/reader-edition-v17/scripts/reader_project_controller.py task-update . ch01-p0006-p0010-r8 --status approved
```
