# Reader-edition translation task ch04s01-p0006-p0010-r1

## Immutable task metadata

- Chapter: `ch04s01` — 第四章 货币转化为资本
- Paragraphs: `v1-ch04s01-p0006` through `v1-ch04s01-p0010`
- Source slice SHA-256: `8582ffa3ad3e9144560e70532e251e0f55425d5bf1ef266c2b3e96bcde57fbcd`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch04s01/drafts/ch04s01-p0006-p0010-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s01-p0006-p0010-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s01-p0006-p0010-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s01-p0006-p0010-r1 --status meaning_reviewed --review-path chapters/ch04s01/reviews/ch04s01-p0006-p0010-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s01-p0006-p0010-r1 --status readability_reviewed --review-path chapters/ch04s01/reviews/ch04s01-p0006-p0010-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s01-p0006-p0010-r1 --status approved
```
