# Reader-edition translation task ch09-p0006-p0010-r2

## Immutable task metadata

- Chapter: `ch09` — 第九章 剩余价值率和剩余价值量
- Paragraphs: `v1-ch09-p0006` through `v1-ch09-p0010`
- Source slice SHA-256: `dff700d5bb369ba880f67ea7f6cc20ffa0a2601d60c924c83abff3c03d5e1f81`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch09/drafts/ch09-p0006-p0010-r2.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r2 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r2 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r2 --status meaning_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r2-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r2 --status readability_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r2-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r2 --status approved
```
