# Reader-edition translation task ch09-p0006-p0010-r1
...
- Draft output: `chapters/ch09/drafts/ch09-p0006-p0010-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r1 --status meaning_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r1 --status readability_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r1 --status approved
```
