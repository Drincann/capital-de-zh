# Reader-edition translation task ch09-p0006-p0010-r3
...
- Draft output: `chapters/ch09/drafts/ch09-p0006-p0010-r3.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r3 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r3 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r3 --status meaning_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r3-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r3 --status readability_reviewed --review-path chapters/ch09/reviews/ch09-p0006-p0010-r3-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0006-p0010-r3 --status approved
```
