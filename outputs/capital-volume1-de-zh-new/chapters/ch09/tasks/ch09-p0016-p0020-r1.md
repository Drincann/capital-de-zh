# Reader-edition translation task ch09-p0016-p0020-r1

## Immutable task metadata

- Chapter: `ch09` — 第九章 剩余价值率和剩余价值量
- Paragraphs: `v1-ch09-p0016` through `v1-ch09-p0020`
- Source slice SHA-256: `54fa39e3bb222f3adad5dd6e82ce7c7e4fdf5275659fa9e53d504aa8cc5ef960`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch09/drafts/ch09-p0016-p0020-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0016-p0020-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0016-p0020-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0016-p0020-r1 --status meaning_reviewed --review-path chapters/ch09/reviews/ch09-p0016-p0020-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0016-p0020-r1 --status readability_reviewed --review-path chapters/ch09/reviews/ch09-p0016-p0020-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch09-p0016-p0020-r1 --status approved
```
