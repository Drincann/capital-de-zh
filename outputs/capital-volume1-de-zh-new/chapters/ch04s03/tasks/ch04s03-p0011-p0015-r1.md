# Reader-edition translation task ch04s03-p0011-p0015-r1

## Immutable task metadata

- Chapter: `ch04s03` — 第四章 货币转化为资本
- Paragraphs: `v1-ch04s03-p0011` through `v1-ch04s03-p0015`
- Source slice SHA-256: `09561c0bee74555040832c8738050526c1565a33adaca95072b4236852302eb3`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch04s03/drafts/ch04s03-p0011-p0015-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s03-p0011-p0015-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s03-p0011-p0015-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s03-p0011-p0015-r1 --status meaning_reviewed --review-path chapters/ch04s03/reviews/ch04s03-p0011-p0015-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s03-p0011-p0015-r1 --status readability_reviewed --review-path chapters/ch04s03/reviews/ch04s03-p0011-p0015-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch04s03-p0011-p0015-r1 --status approved
```
