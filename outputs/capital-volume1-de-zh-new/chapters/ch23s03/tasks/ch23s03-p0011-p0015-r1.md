# Reader-edition translation task ch23s03-p0011-p0015-r1

## Immutable task metadata

- Chapter: `ch23s03` — 第二十三章 资本主义积累的一般规律
- Paragraphs: `v1-ch23s03-p0011` through `v1-ch23s03-p0015`
- Source slice SHA-256: `92d96c8b1fd08c201dc4db601e5d701345c644accf0f978950ce2aa965bb80b2`
- Active specification SHA-256: `f8c22c64bfc4a917fd412f0043b19f455924da8c944b12bee0bb1660d1cf9a48`
- Draft output: `chapters/ch23s03/drafts/ch23s03-p0011-p0015-r1.md`
...
```text
[v1-ch23s03-p0011] [MEGA p.570,571]
...
[v1-ch23s03-p0015] [MEGA p.573,574]
...
8. Save each review under `chapters/ch23s03/reviews/`.
