# Reader-edition translation task ch23s01-p0006-p0008-r2

## Immutable task metadata

- Chapter: `ch23s01` — 第二十三章 资本主义积累的一般规律
- Paragraphs: `v1-ch23s01-p0006` through `v1-ch23s01-p0008`
- Source slice SHA-256: `e52a48b6cc05cd965bb78eac83aee297fc51c42a3badf1eac513253ab5139123`
- Active specification SHA-256: `f8c22c64bfc4a917fd412f0043b19f455924da8c944b12bee0bb1660d1cf9a48`
- Draft output: `chapters/ch23s01/drafts/ch23s01-p0006-p0008-r2.md`
...
[note-009] [MEGA p.557]
77a) „Gehen wir aber nun auf unsere erste Untersuchung zurück, wo nachgewiesen ist... daß das Kapital selbst nur das Erzeugniß menschlicher Arbeit ist... so scheint es ganz unbegreiflich, daß der Mensch unter die Herrschaft seines eigenen Produkts – das Kapital – gerathen und diesem untergeordnet werden könne; und da dieß in der Wirklichkeit doch unläugbar der Fall ist, so drängt sich unwillkürlich die Frage auf: wie hat der Arbeiter aus dem Beherrscher des Kapitals – als Schöpfer desselben – zum Sklaven des Kapitals werden können?“ (Von Thünen: „Der isolirte Staat. Zweiter Theil. Zweite Abtheilung. Rostock 1863“, p. 5, 6.) Es ist das Verdienst Thünen’s, gefragt zu heben. Seine Antwort ist einfach kindisch.
```
...
8. Save each review under `chapters/ch23s01/reviews/`.
