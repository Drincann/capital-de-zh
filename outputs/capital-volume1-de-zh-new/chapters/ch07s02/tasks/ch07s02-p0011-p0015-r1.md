# Reader-edition translation task ch07s02-p0011-p0015-r1

## Immutable task metadata

- Chapter: `ch07s02` — 第七章 剩余价值率
- Paragraphs: `v1-ch07s02-p0011` through `v1-ch07s02-p0015`
- Source slice SHA-256: `6118e053025d2f057da06c1cd09c8511cd9eb1e5798b29366f8216486b806ed4`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch07s02/drafts/ch07s02-p0011-p0015-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch07s02-p0011-p0015-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch07s02-p0011-p0015-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch07s02-p0011-p0015-r1 --status meaning_reviewed --review-path chapters/ch07s02/reviews/ch07s02-p0011-p0015-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch07s02-p0011-p0015-r1 --status readability_reviewed --review-path chapters/ch07s02/reviews/ch07s02-p0011-p0015-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch07s02-p0011-p0015-r1 --status approved
```
