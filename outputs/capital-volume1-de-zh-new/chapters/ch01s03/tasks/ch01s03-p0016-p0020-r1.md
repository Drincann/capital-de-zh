# Reader-edition translation task ch01s03-p0016-p0020-r1

## Immutable task metadata

- Chapter: `ch01s03` — 第一章 商品
- Paragraphs: `v1-ch01-s03-p0016` through `v1-ch01-s03-p0020`
- Source slice SHA-256: `fc89f054b87be311c46d113e882efaccff83120c9e2eab67841fe07d38027c14`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch01s03/drafts/ch01s03-p0016-p0020-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r1 --status meaning_reviewed --review-path chapters/ch01s03/reviews/ch01s03-p0016-p0020-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r1 --status readability_reviewed --review-path chapters/ch01s03/reviews/ch01s03-p0016-p0020-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r1 --status approved
```
