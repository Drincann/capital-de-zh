# Reader-edition translation task ch01s03-p0016-p0020-r2

## Immutable task metadata

- Chapter: `ch01s03` — 第一章 商品
- Paragraphs: `v1-ch01-s03-p0016` through `v1-ch01-s03-p0020`
- Source slice SHA-256: `b81e7e80a2593ad034dee2bfd2f56d9298b447355c5638f3d52a7750c1fa043d`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch01s03/drafts/ch01s03-p0016-p0020-r2.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r2 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r2 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r2 --status meaning_reviewed --review-path chapters/ch01s03/reviews/ch01s03-p0016-p0020-r2-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r2 --status readability_reviewed --review-path chapters/ch01s03/reviews/ch01s03-p0016-p0020-r2-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s03-p0016-p0020-r2 --status approved
```
