# Reader-edition translation task ch06-p0006-p0010-r1

## Immutable task metadata

- Chapter: `ch06` — 第六章 不变资本和可变资本
- Paragraphs: `v1-ch06-p0006` through `v1-ch06-p0010`
- Source slice SHA-256: `73f7a079ccfe5284bb403667fcd7bd5b4ff48da5aa49836384d1624b78b42155`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch06/drafts/ch06-p0006-p0010-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0006-p0010-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0006-p0010-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0006-p0010-r1 --status meaning_reviewed --review-path chapters/ch06/reviews/ch06-p0006-p0010-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0006-p0010-r1 --status readability_reviewed --review-path chapters/ch06/reviews/ch06-p0006-p0010-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0006-p0010-r1 --status approved
```
