# Reader-edition translation task ch06-p0021-p0025-r1

## Immutable task metadata

- Chapter: `ch06` — 第六章 不变资本和可变资本
- Paragraphs: `v1-ch06-p0021` through `v1-ch06-p0025`
- Source slice SHA-256: `6dcd282254e3d7a0a626a80c6dc5a48bc57930f33edcea26fd029616403a4dd7`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch06/drafts/ch06-p0021-p0025-r1.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0021-p0025-r1 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0021-p0025-r1 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0021-p0025-r1 --status meaning_reviewed --review-path chapters/ch06/reviews/ch06-p0021-p0025-r1-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0021-p0025-r1 --status readability_reviewed --review-path chapters/ch06/reviews/ch06-p0021-p0025-r1-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch06-p0021-p0025-r1 --status approved
```
