# Reader-edition translation task ch01s02-p0006-p0010-r5

## Immutable task metadata

- Chapter: `ch01s02` — 第一章 商品
- Paragraphs: `v1-ch01-s02-p0006` through `v1-ch01-s02-p0010`
- Source slice SHA-256: `a553a3ef2ad94c3a3f388951f03c4f5c03e4968903627fd3f269f7ea3abdc328`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch01s02/drafts/ch01s02-p0006-p0010-r5.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s02-p0006-p0010-r5 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s02-p0006-p0010-r5 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s02-p0006-p0010-r5 --status meaning_reviewed --review-path chapters/ch01s02/reviews/ch01s02-p0006-p0010-r5-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s02-p0006-p0010-r5 --status readability_reviewed --review-path chapters/ch01s02/reviews/ch01s02-p0006-p0010-r5-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s02-p0006-p0010-r5 --status approved
```
