# Reader-edition translation task ch01s04-p0006-p0010-r2

## Immutable task metadata

- Chapter: `ch01s04` — 第一章 商品
- Paragraphs: `v1-ch01-s04-p0006` through `v1-ch01-s04-p0010`
- Source slice SHA-256: `40dc38425467d2c2872ee7d71b3c386ee0ba12e669d066b83bb3dde68c4d6318`
- Active specification SHA-256: `d9b415119b3a876eca1f6f653d4cc1e7569459c015252067673e27e60a5ddb48`
- Draft output: `chapters/ch01s04/drafts/ch01s04-p0006-p0010-r2.md`
...
```powershell
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s04-p0006-p0010-r2 --status in_progress
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s04-p0006-p0010-r2 --status drafted
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s04-p0006-p0010-r2 --status meaning_reviewed --review-path chapters/ch01s04/reviews/ch01s04-p0006-p0010-r2-meaning.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s04-p0006-p0010-r2 --status readability_reviewed --review-path chapters/ch01s04/reviews/ch01s04-p0006-p0010-r2-readability.md
python skill-snapshot/reader-edition-v18/scripts/reader_project_controller.py task-update . ch01s04-p0006-p0010-r2 --status approved
```
