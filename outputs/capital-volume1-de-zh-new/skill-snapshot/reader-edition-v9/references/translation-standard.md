...
- split one source paragraph into several reader paragraphs, or join adjacent
  source paragraphs when the argument becomes clearer; final paragraphing need
  not mirror the source;
