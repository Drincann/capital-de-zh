...
all attempts with `-r1`, `-r2`, and `-r3` suffixes. If the final recheck still
has a blocking defect, stop automatic work and request user judgment. Never
start a third revision merely to pursue a preferred wording.
...
source's moves without a material translation-induced ambiguity; it does not
mean no reviewer can suggest a shorter or smoother sentence, and it does not
certify that the argument is true or fully proved. The review is recorded in
