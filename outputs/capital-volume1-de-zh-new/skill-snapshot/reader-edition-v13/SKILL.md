...
6. Run a separate source-blind readability and continuity audit. Do not merely
   ...
   Rewrite anything a normal reader must decode twice, any silent change of
   conceptual subject, and any paragraph that reads as a list rather than a line
   of reasoning. Audit every changed paragraph boundary and reject changes made
...
9. Assemble only approved chunks into the clean chapter Markdown.
